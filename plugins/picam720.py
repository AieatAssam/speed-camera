...
# ===================
cal_obj_px_L2R = 330     # L2R Moving Objects, Length of a calibration object in pixels
cal_obj_mm_L2R = 4605.0  # L2R Moving Objects, Length of the calibration object in millimetres
cal_obj_px_R2L = 330     # R2L Moving Objects, Length of a calibration object in pixels
cal_obj_mm_R2L = 4605.0  # R2L Moving Objects, Length of the calibration object in millimetres

# Motion Event Settings
# ---------------------
MIN_AREA = 400         # Default= 100 Exclude all contours less than or equal to this sq-px Area
x_diff_max = 80        # Default= 25  Exclude if max px away >= last motion event x pos
x_diff_min = 1         # Default= 1  Exclude if min px away <= last event x pos
track_timeout = 0.1    # Default= 0.0 Optional seconds to wait after track End (Avoid dual tracking)
...
CAMERA_FRAMERATE = 40  # Default= 25 framerate for video stream max for V2 can be higher
