...
# --------------------
cal_obj_px_L2R = 165      # L2R Moving Objects, Length of a calibration object in pixels
cal_obj_mm_L2R = 4605  # L2R Moving Objects, Length of the calibration object in millimetres
cal_obj_px_R2L = 165      # R2L Moving Objects, Length of a calibration object in pixels
cal_obj_mm_R2L = 4605  # R2L Moving Objects, Length of the calibration object in millimetres
...
# ---------------------
MIN_AREA = 250         # Default= 100 Exclude all contours less than or equal to this sq-px Area
x_diff_max = 70        # Default= 20  Exclude if max px away >= last motion event x pos
...
CAMERA_FRAMERATE = 40  # Default= 30 Frame rate for video stream V2 picam can be higher
